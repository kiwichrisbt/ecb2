...
<h2>color_picker #2d</h2>
{content_module module="ECB2" field="color_picker" block="test2_2d" label="Test 2-2d: color_picker no-hash" no_hash=1 assign=test2_2d}
<p style="color:#FFF; background-color:{$test2_2d};">colour:'{$test2_2d}'</p>

<h2>color_picker #2e</h2>
{content_module module="ECB2" field="color_picker" block="test2_2e" label="Test 2-2e: color_picker clear_css_cache" clear_css_cache=1 assign=test2_2e}
<p style="color:#FFF; background-color:{$test2_2e};">colour:'{$test2_2e}'</p>

<h2>color_picker - promo_bgcolor clear_css_cache</h2>
{$promo_bgcolor="{content_module module='ECB2' field='color_picker' block='promo_bgcolor' label='Background Color & clear_css_cache' clear_css_cache=1}" scope=global}
...
<h2>Test 3C: dropdown - using dropdown from module</h2>
<p>{$tempVals="Apple=apple,Orange=orange,Banana,Pineapple,Test number 5,Test 6,Test7,Test8,test9,test10,test11"}{content_module module="ECB2" field="dropdown" block="test3C" label="Test 3C: dropdown - from module" mod="LISEProjects" template_summary="item_dropdown" description="Test description (optional) can be shown here" pagelimit=20}</p>

<h2>Test 3D: dropdown - using dropdown from module - with flip_values</h2>
<p>{$tempVals="Apple=apple,Orange=orange,Banana,Pineapple,Test number 5,Test 6,Test7,Test8,test9,test10,test11"}{content_module module="ECB2" field="dropdown" block="test3D" label="Test 3D: dropdown - from module - with flip_values" mod="LISEProjects" template_summary="item_dropdown" description="Test description (optional) can be shown here" pagelimit=20 flip_values=1}</p>
...
<h2>Test 9A: datepicker</h2>
<p>{content_module module="ECB2" field="datepicker" label="Test 9A: datepicker" block="test9A" description="Test with options: change_month, change_year, year_range='1990:2050, and time" change_month=true change_year=1 year_range='1990:2050' time=1}</p>
...
<h2>16b: sortablelist - using module template</h2>
{content_module module='ECB2' field='sortablelist' block='test16b' label='test16b: sortablelist - using module template' mod="LISEProjects" template_summary="item_dropdown"}
...
<h2>Test 23: image</h2>
{content_module module="ECB2" field="image" label="Test 23: image" block="test23" image='images/photo-coming-soon-4-3.jpg' description="Test description (optional) can be shown here - this is an admin only image"}
