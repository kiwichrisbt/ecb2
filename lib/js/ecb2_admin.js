...
//    });
    $(document).on('click', '.ecb2-repeater-add', function(e) {
        ...
        var $newRepeater = $repeater.find('.repeater-wrapper').first().clone();
        $newRepeater.find('.repeater-field').val('').attr('name', $repeater.data('block-name')+'[]');
        $repeater.append($newRepeater);
